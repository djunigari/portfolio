...
export default function Footer({ className }: { className?: string }) {
  return (
    <footer
      className={`grid grid-col-1 md:grid-cols-3 gap-4 p-10 bg-base-200 text-neutral-content opacity-75 ${className}`}
    >
      ...
      <div className="flex md:justify-end">
        <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-col text-xs">
            <span>Alexandre Djun Igari.</span>
            <span>Ozzytec Informatica LTDA</span>
            <span> CNPJ: 50.698.902/0001-11</span>
          </div>
        </div>
      </div>
    </footer>
